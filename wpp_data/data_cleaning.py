...
# def process_mortality_rates(life_table_male_csv1, life_table_male_csv2,
#                             life_table_female_csv1, life_table_female_csv2,
#                             output_csv, country):
...
#         numeric_cols = ['Time', 'Age', 'mx']
#         for col in numeric_cols:
#             df[col] = pd.to_numeric(df[col], errors='coerce')

#         return df[['Time', 'Age', 'Sex', 'mx']].dropna()

#     # Load and clean each file
#     male1 = load_and_clean(life_table_male_csv1, 'Male')
#     male2 = load_and_clean(life_table_male_csv2, 'Male')
#     female1 = load_and_clean(life_table_female_csv1, 'Female')
#     female2 = load_and_clean(life_table_female_csv2, 'Female')

#     # Combine all cleaned data
#     combined = pd.concat([male1, male2, female1, female2], ignore_index=True)

#     # Pivot to wide format
#     result = combined.pivot_table(index=['Age', 'Sex'], columns='Time', values='mx').reset_index()
