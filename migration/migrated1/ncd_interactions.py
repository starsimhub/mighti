...
class obesity_diabetes2(ss.Connector):
    ...
    def __init__(self, pars=None, **kwargs):
        super().__init__(name='Obesity-Type2Diabetes', requires=[mi.Obesity, mi.Type2Diabetes])
...
class depression_obesity(ss.Connector):
    ...
    def __init__(self, pars=None, **kwargs):
        super().__init__(name='Depression-Obesity', requires=[mi.Depression, mi.Obesity])
        self.update_pars(pars, **kwargs)
...
class hypertension_heart(ss.Connector):
    ...
    def __init__(self, pars=None, **kwargs):
        super().__init__(name='Hypertension-Heart', requires=[mi.Hypertension, mi.HeartDisease])
        self.update_pars(pars, **kwargs)
