...
for disease in ncds:
    ...
    try:
        ...
        print(f"Adding {disease} to disease_objects")
...
for disease in ncds:
    ...
    if hasattr(mi, func_name):
        interaction_functions[disease] = getattr(mi, func_name)
    else:
        print(f"Warning: Interaction function {func_name} for {disease} is missing.")
