...
from prepare_data_for_year import prepare_data_for_year
...
def test_life_expectancy():
    ...
    mx_path = os.path.join(thisdir, '..', 'demography', 'eswatini_mx.csv')
    ex_path = os.path.join(thisdir, '..', 'demography', 'eswatini_ex.csv')
    ...
    # obs_mx = prepare_data_for_year.extract_indicator_for_plot(mx_path, 2008, value_column_name='mx')
    # obs_ex = prepare_data_for_year.extract_indicator_for_plot(ex_path, 2008, value_column_name='ex')
