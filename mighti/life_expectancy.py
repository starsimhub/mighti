...
#     Args:
#         sim: The simulation object containing the analyzers.
#         year: The year for which mortality rates are being calculated (optional).
#         max_age: The maximum age for which mortality rates are calculated.
#         radix: The initial population size for survivorship calculations.

#     Returns:
#         A pandas DataFrame containing age-specific mortality rates.
#     """
...
#     # Calculate deaths, person-years, and mortality rates for each age
#     for age in range(max_age):
#         for sex in ['Male', 'Female']:
