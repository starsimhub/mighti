...
# class Type2Diabetes(GenericDisease): pass
class Hypertension(GenericDisease): pass
class Obesity(GenericDisease): pass
class CardiovascularDiseases(GenericDisease): pass
class ChronicKidneyDisease(GenericDisease): pass
class Hyperlipidemia(GenericDisease): pass
class CervicalCancer(GenericDisease): pass
class ColorectalCancer(GenericDisease): pass
class BreastCancer(GenericDisease): pass
class LungCancer(GenericDisease): pass
class ProstateCancer(GenericDisease): pass
class AlcoholUseDisorder(GenericDisease): pass
class TobaccoUse(GenericDisease): pass
class HIVAssociatedDementia(GenericDisease): pass
class PTSD(GenericDisease): pass
class Depression(GenericDisease): pass
class HPV(GenericDisease): pass
class Flu(GenericDisease): pass
class ViralHepatitis(GenericDisease): pass
class DomesticViolence(GenericDisease): pass
class RoadInjuries(GenericDisease): pass
class ChronicLiverDisease(GenericDisease): pass
class Asthma(GenericDisease): pass
class COPD(GenericDisease): pass
...
class Type2Diabetes(ss.NCD):
    def __init__(self, pars=None, **kwargs):
        super().__init__()
        self.define_pars(
            dur_condition=ss.lognorm_ex(type2diabetes_params["dur_condition"]),
            incidence_prob=type2diabetes_params["incidence_prob"], 
            incidence=ss.bernoulli(type2diabetes_params["incidence_prob"]),
            p_death=ss.bernoulli(type2diabetes_params["p_death"]),
            init_prev=ss.bernoulli(type2diabetes_params["init_prev"]),
...
#         adjusted_cases = sc.randbin(new_cases, self.rel_sus[self.susceptible.uids])
    
#         self.set_prognoses(adjusted_cases)
...
# class CardiovascularDiseases(ss.Disease):
#     pass
#     # def __init__(self, pars=None, **kwargs):
#     #     super().__init__()
#     #     self.define_pars(init_prev=ss.bernoulli(0.02))
